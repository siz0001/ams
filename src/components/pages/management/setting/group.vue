  ...
  <Layout title="그룹관리">
    <div class="mt-[50px] px-10 flex flex-col gap-1 lg:flex-row lg:items-center lg:gap-1 justify-between bg-[#f3f9ff] py-6">
      <div class="flex items-center space-x-2">
        ...
        <v-text-field class="w-[220px] bg-white" color="primary" density="compact" label="측정기명" variant="outlined" hide-details="auto" shaped></v-text-field>
      ...
      <div class="min-w-[600px]">
        ...
        <div class="bg-white px-[50px] py-[30px]">
          <div class="bg-[#f3f9ff] px-5 flex items-center space-x-2 h-[88px]">
            <v-text-field color="primary" label="상위그룹" variant="outlined" hide-details="auto"></v-text-field>
            <v-text-field color="primary" label="하위그룹" variant="outlined" hide-details="auto"></v-text-field>
          </div>
