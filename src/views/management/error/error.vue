    ...
    <v-dialog v-model="dialog">
      <div class="min-w-[950px]">
        <div class="bg-[#1b53a0] h-[80px] flex items-center justify-between pl-[50px] px-[38px]">
          <div class="text-xl text-white font-bold">장애 관리</div>
        ...
        <div class="bg-white px-[50px] py-[30px]">
          <div class="space-y-[10px]">
            ...
            <div class="flex items-center space-x-[10px]">
              <v-text-field color="primary" label="센세명" variant="outlined" hide-details="auto" class="flex-1"></v-text-field>
              <v-text-field color="primary" label="IP" variant="outlined" hide-details="auto" class="flex-1"></v-text-field>
            </div>
            <div class="flex items-center space-x-[10px]">
              <v-text-field color="primary" label="장애등급" variant="outlined" hide-details="auto" class="flex-1"></v-text-field>
              <v-text-field color="primary" label="상태" variant="outlined" hide-details="auto" class="flex-1"></v-text-field>
            </div>
            <div class="flex">
              <v-text-field color="primary" label="장애등급" variant="outlined" hide-details="auto" class="w-[calc(50%-5px)] flex-none"></v-text-field>
            </div>
          </div>
